...
public class xml_factura2 {
    ...
    public static String tipo_documento_cliente; //ver
   ...
   public xml_factura2(Cabecera cab,ArrayList<Detalle> detalles) {
	   ...
	   this.tipo_documento_cliente = cab.tipDocIdeUsuario;
 ...
 //firma electronica y final de metodo inicio_cabecera xml
  ...
  //montos del igv, se puede modificar para otros tributos aparte del IGV
   ...
   public static void productos_datos() {
	   ...
	   archivo.println("</cac:AllowanceCharge>");
	   archivo.println("<cac:TaxTotal>");
	   archivo.println("  <cbc:TaxAmount currencyID=\""+tipo_moneda+"\">"+detalles.get(i-1).getMontoIGVPorItem()+"</cbc:TaxAmount>");//Monto de IGV por �tem
	   archivo.println("  <cac:TaxSubtotal>");
	   archivo.println("    <cbc:TaxableAmount currencyID=\""+tipo_moneda+"\">"+detalles.get(i-1).getMontoIGVPorItem()+"</cbc:TaxableAmount>");//Monto de IGV por �tem
	   archivo.println("    <cbc:TaxAmount currencyID=\""+tipo_moneda+"\">"+detalles.get(i-1).getMontoIGVPorItem()+"</cbc:TaxAmount>");//Monto de IGV por �tem
	   archivo.println("    <cac:TaxCategory>");
	   archivo.println("      <cbc:TaxExemptionReasonCode>"+detalles.get(i-1).getAfectIGV()+"</cbc:TaxExemptionReasonCode>");//Afectaci�n al IGV
	   archivo.println("      <cac:TaxScheme>");
	   ...
	   archivo.println("      <cbc:ID>"+detalles.get(i-1).getCodProducto()+"</cbc:ID>");//C�digo de producto
	   archivo.println("  </cac:SellersItemIdentification>");
